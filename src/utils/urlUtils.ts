...
const constructGradesFilters = (gradingSystem: RouteGradingSystem | undefined, minDifficulty: string, maxDifficulty: string): string => {
...
export const constructFilteredRoutesUrl = (baseMostRelevantAreaUrl: string, searchPageUserData: AreasSearchUserData): string => {
    const {
        minDifficulty,
        maxDifficulty,
        gradingSystem,
